  ...
  "inline-flex items-center justify-center rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        glow: "bg-gradient-to-r from-primary to-primary-glow text-primary-foreground hover:shadow-glow hover:scale-105 border-2 border-primary-glow/30",
        outline: "border-2 border-primary-glow/30 bg-transparent hover:bg-primary-glow/10 hover:border-primary-glow hover:shadow-glow-sm",
